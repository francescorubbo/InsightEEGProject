...
def train(images, labels, fold, model_type, batch_size=32, num_epochs=5, trainfrac=1.0):
    """
    ...
    (X_train, y_train), (X_val, y_val), (X_test, y_test) = reformatInput(images, labels, fold, trainfrac)
    ...
    return y_train.shape[0],av_test_acc
...
if __name__ == '__main__':
    ...
    print('Loading data...')
    locs = scipy.io.loadmat('../EEGLearn/Sample data/Neuroscan_locs_orig.mat')
    locs_3d = locs['A']
    locs_2d = []
    # Convert to 2D
    for e in locs_3d:
    ...
    train(images, labels, fold_pairs[2], 'cnn', trainfrac=1.0)
